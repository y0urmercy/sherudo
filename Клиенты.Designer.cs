namespace sherudo
{
    partial class Клиенты
    {
        ...
        private void InitializeComponent()
        {
            ...
            Контактный_телефон = new DataGridViewTextBoxColumn();
            button1 = new Button();
            label1 = new Label();
            button4 = new Button();
            ...
            dataGridView1.Columns.AddRange(new DataGridViewColumn[] { Код_клиента, Фамилия, Имя, Отчество, Контактный_телефон });
            dataGridView1.Location = new Point(12, 6);
            dataGridView1.Name = "dataGridView1";
            dataGridView1.Size = new Size(543, 362);
            ...
            // Контактный_телефон
            // 
            Контактный_телефон.HeaderText = "Контактный телефон";
            Контактный_телефон.Name = "Контактный_телефон";
            // 
            // button1
            // 
            ...
            label1.Location = new Point(227, 404);
            label1.Name = "label1";
            ...
            button4.Location = new Point(838, 183);
            ...
            // textBox4
            // 
            textBox4.Location = new Point(685, 183);
            ...
            label6.Location = new Point(580, 183);
            label6.Name = "label6";
            ...
            // textBox3
            // 
            textBox3.Location = new Point(662, 118);
            ...
            // textBox2
            // 
            textBox2.Location = new Point(685, 89);
            ...
            button3.Location = new Point(838, 120);
            ...
            label5.Location = new Point(580, 120);
            label5.Name = "label5";
            ...
            label4.Location = new Point(580, 93);
            label4.Name = "label4";
            ...
            button2.Location = new Point(838, 24);
            ...
            label3.Location = new Point(579, 26);
            label3.Name = "label3";
            ...
            // textBox1
            // 
            textBox1.Location = new Point(662, 23);
        ...
        private DataGridViewTextBoxColumn Контактный_телефон;
