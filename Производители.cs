...
namespace sherudo
{
    public partial class Производители : Form
    {
        public Производители()
        {
            InitializeComponent();
        }
        public string table = "dbo.Производители$";

        private void Производители_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM dbo.Производители$";
