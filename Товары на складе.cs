...
namespace sherudo
{
    public partial class Товары_на_складе : Form
    {
        public Товары_на_складе()
        {
            InitializeComponent();
        }
        public string table = "dbo.Товары_на_складе$";
        private void Товары_на_складе_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM dbo.Товары_на_складе$";
